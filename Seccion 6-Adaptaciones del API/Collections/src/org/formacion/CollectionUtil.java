...
public class CollectionUtil {
	...
	/**
	 * Modifica la lista original de personas eliminando las personas que 
	 * tengan un nombre con un espacio en blanco 
	 */
	public void eliminaNombresConEspacios(List<Persona> original) {
		original.removeIf(per -> per.getNombre().contains(" "));
	}
	
	/**
	 * Modifica la lista pasando todos los nombres a mayúscula (nombre, primer y segundo apellido)
